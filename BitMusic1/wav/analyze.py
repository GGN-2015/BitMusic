# -*- coding: utf-8 -*-
"""
    代码改编自 https://blog.csdn.net/sinat_33588424/article/details/80239375
    仅供学习使用，并不是框架的一部分
"""
...
fileName = input("[wav/analyze] input fileName >>>")
...
print(" - nchannels = " + str(nchannels)) # 声道数量
print(" - sampwidth = " + str(sampwidth)) # 量化位数
print(" - framerate = " + str(framerate)) # 采样频率
print(" - nframes   = " + str(  nframes)) # 采样点数
...
if nchannels == 2: # 注：原博客的输出算法针对的是双声道数据
    ...
    print("[wav/analyze] warning: <nchannels = %d> not supported." % nchannels)
